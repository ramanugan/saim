        ...
        children: [
          Wrap(
            ...
            children: [
              ...
              Text(
                'Soriana · Zona Occidente · Río Nilo',
                style: TextStyle(
              ...
              Text(
                'IG-00028 · OS-2026-00541 · preventivo programado',
                style: TextStyle(
          ...
          Wrap(
            ...
            children: [
              ...
              _buildRibbonAction(context, 'Ver calendario'),
              _buildRibbonAction(context, 'Ver cuadrilla'),
            ],
          ),
        ],
      ),
