                            ...
                            children: [
                              ...
                              _buildSubNavItem(
                                ...
                                onTap: () {
                                  showDialog(
                                    context: context,
                                    builder: (ctx) => const CrudRefaccionesAliasModal(),
                                  );
                                },
                              ),
                              _buildSubNavItem(
                                ...
                                onTap: () {
                                  showDialog(
                                    context: context,
                                    builder: (ctx) => const CrudSuministrosRefaccionModal(),
                                  );
                                },
                              ),
                              _buildSubNavItem(
                              ...
                              _buildSubNavItem(
                                ...
                                onTap: () {
                                  showDialog(
                                    context: context,
                                    builder: (ctx) => const CrudProveedorRefaccionModal(),
                                  );
                                },
                              ),
                              _buildSubNavItem(
                              ...
                              _buildSubNavItem(
                                ...
                                onTap: () {
                                  showDialog(
                                    context: context,
                                    builder: (ctx) => const CrudSolicitudRefaccionDetalleModal(),
                                  );
                                },
                              ),
                              _buildSubNavItem(
